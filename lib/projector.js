...
var project = {
  ...
  'FeatureCollection': function(inProjection, outProjection, fc) {
    ...
    // NB: not cloning the FC improves performance significantly.
    // However, it means that you are editing the base data
    for (var i = 0; i < fc.features.length; i++) {
      fc.features[i] = project.Feature(from, to, fc.features[i]);
    }
