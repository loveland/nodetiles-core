...
var renderPath = {
    ...
    'LineString': function(l) {
      // TODO: explain in English what this does. 
      var start = l[0];
      if (transform) {
...
// NB -- renderDashedPath has not been optimized.
...
var renderDashedPath = {
  ...
  // TODO: describe in English what this does.
      ...
      for (var i = 0; i < features.length; i++) {
        ...
        var renderInstance = function(instanceName) {
          ...
          for (var key in instanceStyle) {
            ...
            // BUT it breaks background images. Gotta fix this sometime. 
        ...
        for (var ioIdx = 0; ioIdx < instanceOrder.length; ioIdx++) {
